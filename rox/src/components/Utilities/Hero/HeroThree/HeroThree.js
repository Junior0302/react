                    ...
                    <div className="container">
                        <div className="row justify-content-center pt-50 text-center">
                            <div className="col-lg-12 col-md-12">
                                ...
                                <h2 data-animation="fadeInUp" data-delay=".4s">Êtes-vous prêt pour <br />votre prochain défi ?</h2>


<div className="slider-btn">
<Link to={'/a-propos'} className="btn ss-btn mr-15">{'En savoir plus'}</Link>                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
